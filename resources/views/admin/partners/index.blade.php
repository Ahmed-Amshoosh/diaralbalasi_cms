    ...
    <div class="space-y-8">
            ...
            <form id="sectionForm" action="{{ route('admin.partners.section.update') }}" method="POST" novalidate>
                ...
                <div class="p-6">
                    <div id="tab-content-ar" class="tab-content space-y-5">
                        <div>
                            <label
                                class="block text-sm font-semibold text-gray-700 mb-1.5">{{ __('messages.why_us_label') }}
                        ...
                        <div>
                            <label
                                class="block text-sm font-semibold text-gray-700 mb-1.5">{{ __('messages.why_us_heading') }}
                                <span class="text-red-500">*</span></label>
                            <input type="text" name="heading_ar" id="heading_ar"
                                   value="{{ old('heading_ar', $section?->getTranslation('heading', 'ar') ?? '') }}"
                                   class="w-full px-4 py-2.5 border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-blue-500 transition-all"
                                   dir="rtl" required>
                            <p class="field-error text-red-500 text-xs mt-1.5 hidden" id="error-heading_ar"><i
                                    class="fas fa-exclamation-circle"></i> {{ __('messages.this_field_is_required') }}
                            </p>
                        </div>
                        <div>
                            <label
                                class="block text-sm font-semibold text-gray-700 mb-1.5">{{ __('messages.why_us_description') }}
                                <span class="text-red-500">*</span></label>
                            <textarea name="description_ar" id="description_ar" rows="4"
                                      ...
                                      dir="rtl"
                                      required>{{ old('description_ar', $section?->getTranslation('description', 'ar') ?? '') }}</textarea>
                            <p class="field-error text-red-500 text-xs mt-1.5 hidden" id="error-description_ar"><i
                                    class="fas fa-exclamation-circle"></i> {{ __('messages.this_field_is_required') }}
                            </p>
                        </div>
                    </div>
                    <div id="tab-content-en" class="tab-content space-y-5 hidden">
                        ...
                        <div class="relative">
                            ...
                            <input type="text" name="heading_en" id="heading_en"
                                   ...
                                   class="w-full px-4 py-2.5 border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-blue-500 transition-all"
                                   dir="ltr" required>
                            <p class="field-error text-red-500 text-xs mt-1.5 hidden" id="error-heading_en"><i
                                    class="fas fa-exclamation-circle"></i> {{ __('messages.this_field_is_required') }}
                            </p>
                        </div>
                        <div class="relative">
                            ...
                            <textarea name="description_en" id="description_en" rows="4"
                                      class="w-full px-4 py-2.5 border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-blue-500 transition-all resize-none"
                                      dir="ltr"
                                      required>{{ old('description_en', $section?->getTranslation('description', 'en') ?? '') }}</textarea>
                            <p class="field-error text-red-500 text-xs mt-1.5 hidden" id="error-description_en"><i
                                    class="fas fa-exclamation-circle"></i> {{ __('messages.this_field_is_required') }}
                            </p>
                        </div>
                    </div>
        ...
        <div class="bg-white rounded-xl shadow-sm border border-gray-100 overflow-hidden">
            <div class="p-6 border-b border-gray-100 flex flex-col sm:flex-row justify-between items-center gap-4">
                ...
                @can('create partners')
                    <button onclick="window.openAddPartnerModal()"
                        ...
                        <tr class="hover:bg-gray-50/50 transition-colors">
                            ...
                            <td class="px-6 py-4">
                                <img src="{{ $partner->logo_url }}"
                                     ...
                                     class="h-12 w-auto object-contain bg-gray-50 rounded p-2 border">
                            </td>
                            ...
                            <td class="px-6 py-4 text-center">
                                <div class="flex items-center justify-center gap-2">
                                    @can('edit partners')
                                        <button
                                            onclick="window.openEditPartnerModal({{ $partner->id }}, '{{ addslashes($partner->getTranslation('name', 'ar')) }}', '{{ addslashes($partner->getTranslation('name', 'en')) }}', '{{ $partner->logo }}', {{ $partner->order }}, {{ $partner->is_active ? 1 : 0 }})"
                                    ...
                                    @can('delete partners')
                                        <button
                                            onclick="confirmDelete('{{ route('admin.partners.destroy', $partner->id) }}', '{{ addslashes($partner->getTranslation('name', app()->getLocale())) }}')"
        ...
        <div class="flex items-center justify-center min-h-screen px-4 pt-4 pb-20 text-center sm:block sm:p-0">
            ...
            <div
                ...
                <div class="flex justify-between items-center mb-5 border-b pb-3">
                    <h3 class="text-lg font-bold text-gray-800 flex items-center gap-2">
                        <i class="fas fa-image text-purple-500"></i> <span
                            id="modalTitleText">{{ __('messages.add_partner') }}</span>
                    </h3>
                    <button onclick="window.closePartnerModal()"
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-6 mb-6 text-start">
                        ...
                        <div class="md:col-span-2">
                            <label
                                ...
                                <span class="text-red-500">*</span></label>
                            <input type="file" name="logo" id="item_logo" accept="image/*"
                            ...
                            <p class="field-error text-red-500 text-xs mt-1.5 hidden" id="error-item_logo"><i
                                    class="fas fa-exclamation-circle"></i> {{ __('messages.this_field_is_required') }}
                            </p>
