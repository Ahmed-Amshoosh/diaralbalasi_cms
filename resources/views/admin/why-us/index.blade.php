...
@section('content')
                ...
                <div class="p-6">
                    ...
                    <div id="tab-content-en" class="tab-content space-y-5 hidden">
                        <div class="relative">
                            ...
                            <button type="button" onclick="copySectionField('label_ar', 'label_en')" class="absolute top-9 right-2.5 bg-gray-100 hover:bg-blue-100 text-gray-600 hover:text-blue-600 text-xs px-2 py-1 rounded transition-colors"><i class="fas fa-copy"></i></button>
                        ...
                        <div class="relative">
                            ...
                            <button type="button" onclick="copySectionField('heading_ar', 'heading_en')" class="absolute top-9 right-2.5 bg-gray-100 hover:bg-blue-100 text-gray-600 hover:text-blue-600 text-xs px-2 py-1 rounded transition-colors"><i class="fas fa-copy"></i></button>
                        ...
                        <div class="relative">
                            ...
                            <button type="button" onclick="copySectionField('description_ar', 'description_en')" class="absolute top-9 right-2.5 bg-gray-100 hover:bg-blue-100 text-gray-600 hover:text-blue-600 text-xs px-2 py-1 rounded transition-colors"><i class="fas fa-copy"></i></button>
            ...
            <div class="overflow-x-auto">
                <table class="w-full text-left">
                    ...
                    <tr>
                        ...
                        <th class="px-6 py-4 font-semibold">{{ __('messages.why_us_icon') }}</th>
                        <th class="px-6 py-4 font-semibold">{{ __('messages.why_us_title') }}</th>
    ...
    @push('scripts')
        <script>
            ...
            // ─── 3. دوال النسخ (خارج DOMContentLoaded لضمان التحميل) ───
            window.copySectionField = function(sourceId, targetId) {
