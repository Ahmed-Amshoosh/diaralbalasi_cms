...
@section('content')
    ...
    <script>
        ...
        document.addEventListener('DOMContentLoaded', function () {
            ...
            const spinner =
                sentinel.querySelector('.spinner');

            const loadingText =
                sentinel.querySelector('.loading-text');

            const endText =
                sentinel.querySelector('.end-text');
            ...
            const AJAX_URL =
                @json(route('frontend.products.ajax'));
            ...
            function updateFilterInfo() {
                ...
                if (currentCategory !== 'all') {
                    ...
                    if (categoryButton) {
                        ...
                        const span =
                            categoryButton.querySelector('span');
                ...
                if (currentPartner !== 'all') {
                    ...
                    if (partnerButton) {
                        ...
                        const span =
                            partnerButton.querySelector('span');
